<%-- 
    Document   : visualProceso
    Created on : 2 ene 2023, 15:26:43
    Author     : alanc
--%>
        ...
        <form method="post">
            <table class="table align-middle table-striped" style="text-align: center">
                ...
                <%
                    ...
                    //String id = request.getParameter("find_idT");
                    ps = (PreparedStatement) con.prepareStatement("SELECT * FROM proceso");
